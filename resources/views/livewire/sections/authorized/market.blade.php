<section class="flex-1 p-4 flex flex-wrap flex flex-col gap-7">
    <div class="w-full flex flex-wrap md:flex-nowrap items-center gap-3">
        <div class="w-full md:flex-1 italic text-sm">
        ...
        <x-text-input  
            ...
            type="text" 
            icon="search" 
            styles="text-sm w-full md:w-[180px] border-gray-400 text-gray-400"
        ...
        <x-selector 
            wireModel="sector"  
            styles="text-sm w-full md:w-[200px] border-gray-400 text-gray-400"
