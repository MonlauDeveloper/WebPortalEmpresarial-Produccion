<main x-data>
                ...
                @foreach ($this->companies as $company)
                    <tr class="bg-white border-b">
                        ...
                        <td class="px-6 py-4 gap-5 flex items-center justify-end">
                            ...
                            <span wire:click="delete('{{ $company['id'] }}')" class="material-symbols-outlined hover:text-blue-500 transition-all cursor-pointer">delete</span>
                        </td>
                    </tr>
                @endforeach
            </tbody>
    ...
    <x-modal wire:model="deleting" styles="flex flex-col gap-5">
        <h2>¿Estás seguro de que quieres borrar esta empresa?</h2>
